...
odoo.define('bi_pos_reports.PopupProductWidget', function(require) {
	...
	class PopupProductWidget extends Popup {
		...
		save_product_summery_details(output_summery_product, pro_st_date, pro_ed_date,prod_current_session){
			...
			self.showTempScreen('ProductReceiptWidget',{output_summery_product:output_summery_product, pro_st_date:pro_st_date, pro_ed_date:pro_ed_date,prod_current_session:prod_current_session});
		}
	}
